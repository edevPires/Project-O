const noteInserter = () => {
    ...
    LSnote.lista.forEach((element) => {
        ...
        const newNote = `
            <div class="noteCard">
                <div
                    class="h-full gap-0 overflow-hidden max-h-[6rem] rounded-3xl border border-blue-900 transition-all duration-300 hover:scale-105 hover:cursor-pointer hover:shadow-md  focus:max-h-[100rem]"
                >
                    <h4
